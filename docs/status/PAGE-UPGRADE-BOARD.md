...
| `/dashboard` | Dashboard | Main | P1 | Done | claude | UIUX-001, B2B-001, UIUX-006 | `page-dashboard-upgrade` | `feature-ui-empty-and-skeleton`, `feature-data-binding-and-loading` | `docs/status/PROJECT-STATUS.md`, `docs/status/11-FEATURE-PARITY-MATRIX.md` | 2026-04-27 |
...
| `/coaching/result` | Coaching Result | Main | P0 | Done | claude | UIUX-005, AI-001, AI-COACHING-ANALYTICS-001, monetization-redesign | `page-coaching-result-upgrade` | `feature-ui-empty-and-skeleton`, `feature-data-binding-and-loading` | `docs/status/PROJECT-STATUS.md`, `docs/status/MISSING-AND-UNIMPLEMENTED.md` | 2026-04-27 |
| `/coaching/insights` | Insights Report (Pro) | Main | P1 | Done | claude | monetization-redesign | — | `feature-data-binding-and-loading`, `feature-error-and-retry-state` | `docs/status/PROJECT-STATUS.md` | 2026-04-23 |
| `/training/academy` | Academy | Training | P0 | QA | claude | UIUX-002, UIUX-003, UI-TRAINING-PERSONALIZATION-001 | `page-training-academy-upgrade` | `feature-navigation-and-gesture`, `feature-data-binding-and-loading` | `docs/status/PROJECT-STATUS.md`, `docs/ref/TRAINING-PERSONALIZATION-GUIDE.md` | 2026-04-27 |
| `/training/detail` | Training Detail | Training | P0 | Done | claude | UIUX-005, UI-TRAINING-DETAIL-001 | `page-training-detail-upgrade` | `feature-data-binding-and-loading`, `feature-error-and-retry-state` | `docs/status/PROJECT-STATUS.md`, `docs/ref/TRAINING-PERSONALIZATION-GUIDE.md` | 2026-04-27 |
