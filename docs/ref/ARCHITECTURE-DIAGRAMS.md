...
| `arch-06` | `docs/ref/architecture/06-runtime-deploy-observability.md` | Runtime/deploy/automation observability map | `.claude/automations/*.prompt.md`, `docs/status/AUTOMATION-HEALTH.md`, `docs/status/NIGHTLY-RUN-LOG.md` | 2026-03-01 | ok |
