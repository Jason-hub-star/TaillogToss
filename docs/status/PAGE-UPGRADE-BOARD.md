...
|---|---|---|---|---|---|---|---|---|---|---|
| `/login` | Login | Auth | P2 | Done | claude | AUTH-001 | `page-login-upgrade` | `feature-form-validation-and-submit`, `feature-error-and-retry-state` | `docs/status/PROJECT-STATUS.md`, `docs/ref/AIT-SDK-2X-MIGRATION.md` | 2026-04-02 |
