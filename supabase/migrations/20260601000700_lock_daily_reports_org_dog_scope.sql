-- B2B-001 / AUTH-001: daily_reports must be bound to an active dog in the
-- same org, not only to a caller-controlled created_by_org_id.
...
USING (
  ...
  OR (
    created_by_trainer_id IS NOT NULL
