User-invocable slash commands for TaillogToss.

| Command | File | Purpose |
|---|---|---|
| `/intake` | `intake.md` | 요청 분류 + parity/skill 고정 |
| `/impact-map` | `impact-map.md` | 영향 범위 + 검증 매트릭스 정리 |
...
| `/token-lint` | `token-lint.md` | 스타일 토큰 하드코딩 탐지 |
