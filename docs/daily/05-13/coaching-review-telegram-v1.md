...
- Automation grouping: AI data work is now bundled under `taillog-ai-data-orchestrator` so synthetic generation runs before Telegram review. Individual synthetic/review prompts should not be scheduled separately.
