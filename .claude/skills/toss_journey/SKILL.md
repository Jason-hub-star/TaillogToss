...
|---|------|----------|-------------|----------|
| 1 | login | `screens/login.tsx` | Standalone | 기존 9-1 |
| 2 | **welcome** | `screens/onboarding/welcome.tsx` | B (상세형) | **NEW** |
| 3 | survey | `screens/onboarding/survey.tsx` | C (입력폼형) | 기존 9-2 |
| 4 | **survey-result** | `screens/onboarding/survey-result.tsx` | B (상세형) | **NEW** |
| 5 | dashboard | `screens/dashboard/index.tsx` | D+A (탭+목록) | 기존 9-3 보강 |
| 6 | quick-log | `screens/dashboard/quick-log.tsx` | E (모달형) | 기존 9-4 보강 |
| 7 | analysis | `screens/dashboard/analysis.tsx` | D (탭형) | 기존 9-5 |
| 8 | coaching-result | `screens/coaching/result.tsx` | B (상세형) | 기존 9-6 보강 |
| 9 | training-academy | `screens/training/academy.tsx` | A 변형 (GridList) | 기존 9-7 |
| 10 | **training-detail** | `screens/training/detail.tsx` | B (상세형) | **NEW** |
| 11 | dog-profile | `screens/dog/profile.tsx` | C (입력폼형) | 기존 9-8 |
| 12 | **dog-switcher** | `screens/dog/switcher.tsx` | E (모달형) | **NEW** |
| 13 | **dog-add** | `screens/dog/add.tsx` | C (입력폼형) | **NEW** |
| 14 | settings | `screens/settings/index.tsx` | A (목록형) | 기존 9-9 |
| 15 | **subscription** | `screens/settings/subscription.tsx` | B (상세형) | **NEW** |
| 16 | **notification** | `screens/onboarding/notification.tsx` | B (상세형) | **NEW** |
| 17 | ops-today | `screens/ops/today.tsx` | D+A (탭+목록) | 기존 9-10 |
